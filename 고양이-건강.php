...
<?php
                $connect = mysqli_connect('localhost', 'pkw961027', 'pkw89463795!', 'pkw961027') or die ("connect fail");
                $query ="select * from board5 order by number desc";
                $result = $connect->query($query);
                $total = mysqli_num_rows($result);
        ...
        <div class="container">
          <table class="table table-bordered">
              ...
              <tbody>
                  ...
                  ?>                      <tr>
                          ...
                          <a href = "view5.php?number=<?php echo $rows['number']?>">
          ...
          <p>
              ...
              <input type="button" value="글쓰기" onClick="location.href='./write-고양이건강.php'" />
