...
<?php
                $connect = mysqli_connect('localhost', 'pkw961027', 'pkw89463795!', 'pkw961027') or die ("connect fail");
                $query ="select * from board4 order by number desc";
                $result = $connect->query($query);
                $total = mysqli_num_rows($result);
        ...
        <div class="container">
          <table class="table table-bordered">
              ...
              <tbody>
                  ...
                  ?>                      <tr>
                          ...
                          <a href = "view4.php?number=<?php echo $rows['number']?>">
          ...
          <p>
              ...
              <input type="button" value="목록" onClick="location.href='./강아지-행동.php'" />

              <input type="button" value="글쓰기" onClick="location.href='./write-강아지행동.php'" />
