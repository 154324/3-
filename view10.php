...
<head>
    ...
    <body>
                      ...
                      <div class="header">
                          <div class="header-menu">
                            <?php
                                            ...
                                            $number = $_GET['number'];
                                            session_start();
                                            $query = "select title, content, date, hit, id from board10 where number =$number";
                                            $result = $connect->query($query);
                                            $rows = mysqli_fetch_assoc($result);
                                            $hit = "update board10 set hit=hit+1 where number=$number";
                                            $connect->query($hit);
      ...
      <div id="contents">
          ...
          <!-- MODIFY & DELETE -->
          <div class="view_btn">
                  <input type="button" value="목록" onClick="location.href='./공지사항.php'" />
