...
<head>
    ...
    <body>
      ...
      <div id="contents">
          ...
          <!-- MODIFY & DELETE -->
          <div class="view_btn">
                  <input type="button" value="목록" onClick="location.href='./게시판.php'" />
                  <input type="button" value="삭제"onclick="location.href='./delete.php?number=<?=$number?>&id=<?=$_SESSION['userid']?>'">
          </div>
          ...
          <table class="table table-bordered">
              <tr>
                <p>
                  <td width="500px">
                      ID: <input type="hidden" name="name" value="<?=$_SESSION['userid']?>"><?=$_SESSION['userid']?></td>
              ...
              <tr>
                  <td>
                      <textarea id="reply_content" name="reply_content" rows="4" cols="50" placeholder="댓글을 입력하세요."></textarea><input type="submit" class="btn pull-right"value="댓글 등록">
                  </td>
              </tr>
