...
<?php
        ...
        <div class="container">
          <table class="table table-bordered">
              ...
              <tbody>
                  ...
                  ?>                      <tr>
                          ...
                          <a href = "view3.php?number=<?php echo $rows['number']?>">
          ...
          <p>
              ...
              <input type="button" value="목록" onClick="location.href='./강아지-음식.php'" />

              <input type="button" value="글쓰기" onClick="location.href='./write-강아지음식.php'" />
